...
Most of these come down to network reality or how jisho serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

jisho rate-limits like any public site. jisho already paces
...
Where a surface is gated, jisho reads a cookie or token you supply
...
`jisho`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what jisho actually did
