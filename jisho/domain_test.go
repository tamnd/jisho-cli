...
// HTTP behaviour is covered in jisho_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "jisho://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("jisho", "about")
	if err != nil || got.String() != "jisho://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want jisho://page/about", got.String(), err)
	}
}
